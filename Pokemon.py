...
class Pokemon:
  def __init__(self, Name, Hp, Atk, Def, Spd, Move, Type, Lvl, Desc, CatchRate, Xp = None, Item = None):
    self.Name = Name
    self.Hp = Hp
    self.Atk = Atk
    self.Def = Def 
...
bulbasaur = Pokemon('Bulbasaur', 45, 49, 49, 45, [tackle,vineWhip,blank,blank], ['grass','poison'], 5, 'A strange seed was planted on its back at birth. The plant sprouts and grows with this POKéMON.', 45)